...
const Contact = () => {
    ...
    emailjs
      ...
      .then(
        ...
        (error) => {
          setSuccess(false);
          setErrorMSG(
            "Something went wrong! Please try again later or choose another option to contact me.",
          );
  ...
  return (
    <section
      className="contact md:flex-row sm:items-center sm:justify-center"
      id="contact"
    >
      <div className="md:pl-10">
        ...
        <p>
          <a
            href="https://wa.me/8801739530410?text=Hi%20Mak! "
            target="_blank"
            className="whatsapp-btn"
            rel="noreferrer"
          >
            <span dangerouslySetInnerHTML={{ __html: whatsAppIcon }}></span> Get
            me on WhatsApp
          </a>
        </p>
      </div>
      ...
      {success ? (
        <p className="mt-10 text-center text-[#06B76A] font-semibold">
          {" "}
          <img
            src={TickCircle}
            alt="success"
          ...
          />{" "}
          Your message has been sent. Thank you for reaching out to me. I'll be
        ...
        <form ref={form} onSubmit={handleSubmit(onSubmit)}>
          ...
          <input type="submit" value={submitText} className="button-primary" />
